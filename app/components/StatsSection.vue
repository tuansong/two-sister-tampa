    ...
    <div class="container mx-auto px-4 py-12 relative">
      <div class="-mx-4 flex flex-wrap items-center">
        ...
        <div class="lg:w-6/12 mx-auto p-4 w-full">
          ...
          <h3 class="capitalize mb-6">Who we are?</h3>
          <p>
            Welcome to Sweet Sisters Dessert Delights, where our journey began with a shared love for creating
            irresistible treats. Founded by sisters Ly and Linh, our store is more than just a place to satisfy your
            sweet tooth—it's a celebration of family, creativity, and community.
          </p>
          <div class="-mx-4 flex flex-wrap items-center">
