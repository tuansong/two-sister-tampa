  ...
  <div class="container mx-auto px-4 py-12 relative">
    <div class="-mx-4 flex flex-wrap items-center">
      ...
      <div class="mx-auto p-4 w-full lg:w-5/12">
        ...
        <p class="mb-6">
          This introduction emphasizes innovation and promises a new experience in the dessert scene of Tampa. It invites customers to explore and enjoy unique and delicious treats that set the store apart from others in the area.
        </p>
