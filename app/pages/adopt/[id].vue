...
definePageMeta({
  ...
  // alias: 'blog',
  title: 'Order Now',
  description: 'Buy your happinese!',
  hidden: true,
  navOrder: 2,
  type: 'primary',
  icon: 'i-mdi-home',
        ...
        <div class="px-8">
          <div class="flex flex-wrap lg:justify-between">
            ...
            <div class="flex items-center justify-center py-4 space-x-4 text-center w-full lg:w-fit">
              <BaseIcon name="i-material-symbols-mark-email-unread-outline" height="28px" />
              ...
              <div
                ...
                <ul>
                  <li class="flex items-center justify-center lg:justify-start">
                    <BaseIcon name="i-material-symbols-check-box-outline" height="28px" /><span
                  ...
                  <li class="flex items-center justify-center mt-4 lg:justify-start">
                    <BaseIcon name="i-bx-bxs-microchip" height="24px"
                  ...
                  <li class="flex items-center justify-center mt-4 lg:justify-start">
                    <BaseIcon name="i-healthicons-sexual-reproductive-health-outline" height="24px"
